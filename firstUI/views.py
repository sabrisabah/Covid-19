...
#df3=pd.read_json('https://code.highcharts.com/mapdata/countries/iq/iq-all.geo.json')
...
def index(request):
    ...
    confirmedGlobal=pd.read_csv('C:\\project\\cov-19-world\\data\\1.csv',encoding='utf-8',na_values=None)
